...
const ContactPage = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section 
        id="contact" 
        className="relative antialiased text-gray-900 py-24 w-full flex items-center justify-center px-4 sm:px-8" 
        style={{ 
      ...
      <section className="py-12 relative overflow-hidden" style={{ backgroundColor: '#FFF8E7' }}>
        {/* Background SVG */}
        <div 
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h3 className="text-lg font-serif font-bold text-primary mb-2">24/7 Availability</h3>
                <p className="text-sm text-muted-foreground">We're always here to help when you need us most</p>
              </div>
              <div className="text-center">
                <div className="w-14 h-14 rounded-full bg-accent/20 flex items-center justify-center mx-auto mb-3">
                  <Mail className="w-7 h-7 text-accent" />
                </div>
                <h3 className="text-lg font-serif font-bold text-primary mb-2">Quick Response</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-serif font-bold text-primary mb-2">Convenient Location</h3>
                <p className="text-sm text-muted-foreground">Visit our office or schedule a virtual consultation</p>
              </div>
            </div>
          </div>
        </div>
