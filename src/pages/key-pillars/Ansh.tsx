      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-6xl mx-auto bg-white rounded-3xl shadow-2xl border border-stone-200 overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2">
            {/* LEFT: FULL IMAGE */}
            <div className="relative h-[320px] sm:h-[420px] md:h-auto">
              <img
            ...
            <div className="p-8 sm:p-10 md:p-14 flex flex-col justify-center">
              ...
              <div className="w-14 h-1 bg-accent rounded-full my-4"></div>

              <p className="uppercase tracking-widest text-sm text-accent font-semibold mb-6">
                Trial Court Advocate
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-8 text-sm sm:text-base text-muted-foreground">
                <div>
