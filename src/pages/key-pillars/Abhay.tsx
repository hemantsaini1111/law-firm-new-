  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative container mx-auto px-4 mt-12 sm:mt-0">
          {/* PROFILE CARD */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="p-6 sm:p-10 md:p-14 flex flex-col justify-between">
                ...
                <div>
                  ...
                  <p className="mt-1 sm:mt-2 uppercase tracking-widest text-[10px] sm:text-sm text-accent font-semibold">
                    Founder & Senior Advocate
                  </p>

                  <div className="w-12 sm:w-16 h-0.5 sm:h-1 bg-accent rounded-full my-4 sm:my-6"></div>
                </div>

                {/* Summary Text */}
                <div className="space-y-4 sm:space-y-5 text-xs sm:text-base text-muted-foreground leading-relaxed">
