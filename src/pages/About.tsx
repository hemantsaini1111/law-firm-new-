              ...
              return (
                <Card key={index} className="bg-white backdrop-blur-sm border-0 border-l-[5px] border-l-gray-500 hover:bg-white transition-all duration-300 hover:shadow-elegant-hover hover:scale-105 rounded-none rounded-tr-lg rounded-br-lg aspect-square">
                  <CardContent className="pt-8 text-center">
                    ...
                    <h3 className="text-xl font-serif font-bold mb-3 text-[#5C3317]">{value.title}</h3>
                    <p className="text-[#5C3317]/80 leading-relaxed">{value.description}</p>
                  </CardContent>
                </Card>
              );
            })}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              ...
              >
                ...
                <img 
                  src={legalExpert} 
                  alt="Legal Expert" 
                  className="w-full h-[350px] md:h-[400px] object-cover group-hover:scale-110 transition-transform duration-500 ease-out"
                  style={{ willChange: 'transform', transform: 'translateZ(0)' }}
                  loading="lazy"
                />
                ...
                <div className="absolute inset-0 z-30 flex flex-col justify-end p-6 md:p-8">
                  ...
                  <div className="transform transition-all duration-300">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full border border-white/30">
                      <span className="text-white text-sm font-semibold">Professional Excellence</span>
                    </div>
                  </div>
                </div>
              ...
              >
                ...
                <div className="absolute inset-0 z-30 flex flex-col justify-end p-6 md:p-8">
                  ...
                  <div className="transform transition-all duration-300">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full border border-white/30">
                      <span className="text-white text-sm font-semibold">Team Collaboration</span>
                    </div>
                  </div>
                </div>
              ...
              <div 
                className="relative group overflow-hidden shadow-elegant-hover hover:shadow-2xl transition-shadow duration-300 hover:scale-[1.01] md:col-span-2"
                style={{ willChange: 'transform', transform: 'translateZ(0)' }}
              >
                <div className="absolute inset-0 bg-gradient-to-br from-primary/20 to-accent/10 z-10 group-hover:from-primary/30 group-hover:to-accent/20 transition-opacity duration-300"></div>
                <img 
                  ...
                  className="w-full h-[450px] md:h-[600px] lg:h-[650px] object-cover object-center group-hover:scale-110 transition-transform duration-500 ease-out"
                  style={{ willChange: 'transform', transform: 'translateZ(0)' }}
                  loading="lazy"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-primary/80 via-primary/40 to-transparent z-20 group-hover:from-primary/90 transition-opacity duration-300"></div>
                ...
                <div className="absolute inset-0 z-30 flex flex-col justify-end p-8 md:p-12">
                  ...
                  <div className="transform transition-all duration-300">
                    <div className="inline-flex items-center gap-2 px-6 py-3 bg-white/20 backdrop-blur-sm rounded-full border border-white/30">
                      <span className="text-white text-base font-semibold">Dedicated Service</span>
                    </div>
                  </div>
                </div>
