            ...
            <div className="md:col-span-2">
              <div className="flex items-center gap-4 mb-6 group">
                <div className="relative">
                  <div className="absolute -inset-1 bg-gradient-to-r from-amber-500/10 to-yellow-500/10 rounded-full blur opacity-0 group-hover:opacity-100 transition duration-500"></div>
                  <img
                    src={logo}
                    alt="Abhay Bharadwaj & Associates Logo"
                    className="relative w-12 h-12 sm:w-16 sm:h-16 object-cover aspect-square rounded-full shadow-xl border border-white/10 group-hover:border-amber-500/20 transition-all duration-300"
                  />
                </div>
                <div className="flex flex-col">
                  <span className="text-xl sm:text-2xl font-serif font-bold text-white">Abhay Bharadwaj & Associates</span>
                  {/* <span className="text-[10px] sm:text-xs uppercase tracking-[0.2em] text-accent/80 font-medium">Law Firm</span> */}
                </div>
              </div>
